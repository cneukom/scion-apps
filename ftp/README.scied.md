...
```bash
$ wget https://raw.githubusercontent.com/netsec-ethz/scion-apps/cneukom/scionftp-scied-docs/ftp/binaries/scion-ftp -O ./scion-ftp
$ wget https://raw.githubusercontent.com/netsec-ethz/scion-apps/cneukom/scionftp-scied-docs/ftp/binaries/hercules -O ./hercules
```
